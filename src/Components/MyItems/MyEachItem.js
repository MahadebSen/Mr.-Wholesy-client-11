    ...
    <div>
      <section className="">
        <div className="flex items-center border-2 border-indigo-500 m-8 rounded-md">
          ...
          <button className="mx-5 my-5 border border-2 px-4 py-2 rounded-lg bg-red-500 text-white font-medium hover:text-black hover:bg-white hover:border-red-500">
            Delete
          </button>
        </div>
      </section>
